...
export function MeetingDetailsPage() {
  ...
  const getMeetingDetails = (id: string): MeetingSummary => meetingSummaries.find(meetingSummary => meetingSummary.id === id)!;
  console.log(meetingSummary.data);
  ...
  return (
    <div className="relative">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold text-gray-900 mb-4">{meetingSummary.data.data.summary.title}</h1>
        ...
        <div className="space-y-8">
          <section>
            ...
            <p className="text-gray-600 bg-gray-50 p-4 rounded-lg">
              {meetingSummary.data.data.summary.content}
            </p>
          </section>
